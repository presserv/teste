...
PROC FNC_incl     // inclusao no arquivo FNCS
...
LOCAL dbfseq_:=drvdbf+"FNC_seq" // arq temporario
...
PROC FNC_get1     // capta variaveis do arquivo FNCS
LOCAL getlist := {}, t_f7_
PRIV  blk_fncs:=.t.
PARA tp_mov
IF tp_mov=INCLUI
...
PROC FNC_MEMO
IF READVAR()="MEMO13"
 EDIMEMO("obs",sistema[op_sis,O_CAMPO,13,O_TITU],14,2,23,37)
ENDI
RETU
