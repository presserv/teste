 ...
 DO WHIL ccop<=nucop                               // imprime qde copias pedida
  ...
  DO WHIL !EOF().AND.(!so_um_reg.OR.imp_reg=RECN())
   ...
   IF (R08701F9()) .OR. so_um_reg                  // se atender a condicao...
    ...
    IMPAC("Processo     Categ Contrato   Falecido                            Endere‡o                                     Falecto",cl,009)
    ...
    @ cl,007 SAY TRAN(GRUPOS->codigo,"999999")     // Codigo
    ...
    @ cl,024 SAY TRAN(codigo,"999999")             // Codigo
...
IF cl>maxli .OR. qt=0                              // quebra de pagina
 IF R08701F9()                                     // pode imprimir?
  @ 2,000 SAY R08703F9()                           // Montagem dos dados
 ENDI
 @ 3,023 SAY &drvpcom+[362]+&drvtcom+R00202F9()    // Complemento
 ...
 @ 9,001 SAY TRAN(GRUPOS->codigo,"999999")         // Codigo
