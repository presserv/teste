 ...
 DO WHIL ccop<=nucop                               // imprime qde copias pedida
  ...
  DO WHIL !EOF().AND.(!so_um_reg.OR.imp_reg=RECN())
   ...
   IF (R08701F9()) .OR. so_um_reg                  // se atender a condicao...
    ...
    @ cl,042 SAY TRAN(M->rbanco,"@!")              // Banco 1
    REL_CAB(2)                                     // soma cl/imprime cabecalho
    @ cl,002 SAY TRAN(rcodigo,"999999")            // Codigo
    @ cl,030 SAY TRAN(GRUPOS->grupo,"!!")          // Grupo
    REL_CAB(1)                                     // soma cl/imprime cabecalho
    @ cl,062 SAY M->rjuros                         // Juros
    REL_CAB(1)                                     // soma cl/imprime cabecalho
    @ cl,002 SAY &drvpcom+"CONTR   DATA   NOME"+&drvtcom
    REL_CAB(1)                                     // soma cl/imprime cabecalho
    @ cl,002 SAY &drvpcom+detprc[01]+space(5)+detdeb[01]+&drvtcom			// det01
    REL_CAB(1)                                     // soma cl/imprime cabecalho
    @ cl,002 SAY &drvpcom+detprc[02]+space(5)+detdeb[02]+&drvtcom			// det02
    @ cl,042 SAY tipo+[-]+circ                     // Circular 1
    @ cl,055 SAY TRAN(CIRCULAR->valor,"@E 999,999.99")       // Valor
    @ cl,066 SAY TRAN(emissao_,"@D")               // Emissao
    REL_CAB(1)                                     // soma cl/imprime cabecalho
    @ cl,002 SAY &drvpcom+detprc[03]+space(5)+detdeb[03]+&drvtcom			// det03
    REL_CAB(1)                                     // soma cl/imprime cabecalho
    @ cl,002 SAY &drvpcom+detprc[04]+space(5)+detdeb[04]+&drvtcom			// det04
    @ cl,055 SAY TRAN(valororig-CIRCULAR->valor,"@E 999,999.99")       // Valor
    REL_CAB(1)                                     // soma cl/imprime cabecalho
    @ cl,002 SAY &drvpcom+detprc[05]+space(5)+detdeb[05]+&drvtcom			// det05
    REL_CAB(1)                                     // soma cl/imprime cabecalho
    @ cl,002 SAY &drvpcom+detprc[06]+space(5)+detdeb[06]+&drvtcom			// det06
    @ cl,042 SAY TRAN(M->vlcst+M->vlseg+M->vlout,"@E 999,999.99")       // Valor
		@ cl,060 SAY TRAN(valororig+vlcst+vlseg+vlout,"@E 999,999.99")// Valor
    REL_CAB(1)                                     // soma cl/imprime cabecalho
    @ cl,002 SAY &drvpcom+detprc[07]+space(5)+detdeb[07]+&drvtcom			// det07
    REL_CAB(1)                                     // soma cl/imprime cabecalho
    @ cl,002 SAY &drvpcom+detprc[08]+space(5)+detdeb[08]+&drvtcom			// det08
    REL_CAB(1)                                     // soma cl/imprime cabecalho
    @ cl,002 SAY &drvpcom+detprc[09]+space(5)+detdeb[09]+&drvtcom			// det09
    REL_CAB(1)                                     // soma cl/imprime cabecalho
    @ cl,002 SAY &drvpcom+detprc[10]+space(5)+detdeb[10]+&drvtcom			// det10
    REL_CAB(1)                                     // soma cl/imprime cabecalho
    ...
    REL_CAB(3)                                     // soma cl/imprime cabecalho
    @ cl,002 SAY GRUPOS->nome                      // Nome
    @ cl,042 SAY GRUPOS->nome                      // Nome
    REL_CAB(2)                                     // soma cl/imprime cabecalho
    @ cl,002 SAY TRAN(rcodigo,"999999")            // Codigo
    @ cl,030 SAY TRAN(GRUPOS->grupo,"!!")          // Grupo
    @ cl,042 SAY TRAN(rcodigo,"999999")            // Codigo
    @ cl,070 SAY TRAN(GRUPOS->grupo,"!!")          // Grupo
    REL_CAB(2)                                     // soma cl/imprime cabecalho
    @ cl,042 SAY TRAN(M->rbanco,"@!")              // Banco 1
    REL_CAB(2)                                     // soma cl/imprime cabecalho
    @ cl,002 SAY tipo+[-]+circ                     // Circular 1
    @ cl,015 SAY TRAN(CIRCULAR->valor,"@E 999,999.99")       // Valor
    @ cl,028 SAY TRAN(emissao_,"@D")               // Emissao
    @ cl,042 SAY tipo+[-]+circ                     // Circular 1
    @ cl,055 SAY TRAN(CIRCULAR->valor,"@E 999,999.99")       // Valor
    @ cl,066 SAY TRAN(emissao_,"@D")               // Emissao
    REL_CAB(2)                                     // soma cl/imprime cabecalho
    @ cl,002 SAY TRAN(valororig-CIRCULAR->valor,"@E 999,999.99")       // Valor
    @ cl,015 SAY TRAN(M->vlcst+M->vlseg+M->vlout,"@E 999,999.99")       // Valor
		@ cl,028 SAY TRAN(valororig+vlcst+vlseg+vlout,"@E 999,999.99")// Valor
    @ cl,042 SAY TRAN(valororig-CIRCULAR->valor,"@E 999,999.99")       // Valor
    @ cl,055 SAY TRAN(M->vlcst+M->vlseg+M->vlout,"@E 999,999.99")       // Valor
		@ cl,066 SAY TRAN(valororig+vlcst+vlseg+vlout,"@E 999,999.99")// Valor
    REL_CAB(2)                                     // soma cl/imprime cabecalho
    REL_CAB(1)                                     // soma cl/imprime cabecalho
