...
PROC HIS_incl     // inclusao no arquivo HISTORIC
...
LOCAL dbfseq_:=drvdbf+"HIS_seq" // arq temporario
...
LOCAL getlist := {}, ord_, chv_, ar_get1:=ALIAS(), l_max, reg_atual:=RECNO()
...
PROC HIS_get1     // capta variaveis do arquivo HISTORIC
