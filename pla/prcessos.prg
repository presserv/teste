...
DO WHIL op_cad!=0
 ...
 DO CASE
  ...
  CASE op_cad=03                                   // consulta global
   ADP_R101(3,13)
...
PROC PRC_incl     // inclusao no arquivo PRCESSOS
...
@ l_s+07,c_s+1 SAY " Bairro...:"
@ l_s+08,c_s+1 SAY " Cidade...:"
@ l_s+09,c_s+1 SAY " Falecido.:"
@ l_s+10,c_s+1 SAY " Sepultam.:"
@ l_s+11,c_s+1 SAY " Data Fal.:"
RETU
...
PROC PRC_get1     // capta variaveis do arquivo PRCESSOS
LOCAL getlist := {}
PRIV  blk_prcessos:=.t.
PARA tp_mov
IF tp_mov=INCLUI
...
IF tp_mov=EXCLUI .OR. tp_mov=FORM_INVERSA
 IF (!EMPTY(codlan) .AND. tp_mov=EXCLUI).AND.nivelop<3
...
ELSEIF tp_mov=INCLUI .OR. tp_mov=RECUPERA .OR. tp_mov=FORM_DIRETA
 IF (op_menu=INCLUSAO .AND. LASTKEY()!=K_ESC) .OR. op_menu!=INCLUSAO
  IF (!EMPTY(codlan) .AND. tp_mov=RECUPERA).AND.nivelop<3
   ALERTA()      // existe registro validado aqui!
   msg="Registro de Lan‡amento"
