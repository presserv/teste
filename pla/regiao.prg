...
PROC REG_incl     // inclusao no arquivo REGIAO
...
LOCAL dbfseq_:=drvdbf+"REG_seq" // arq temporario
...
PROC REG_get1     // capta variaveis do arquivo REGIAO
LOCAL getlist := {}
PRIV  blk_regiao:=.t.
PARA tp_mov
IF tp_mov=INCLUI
