...
/*
 ...
 \ Funcao..: Modelo p/Per¡odo / Bom Pastor - Barra do Pirai
...
IF !EMPTY(drvtapg)                                 // existe configuracao de tam pag?
 ...
 lpp_022=LEFT(drvtapg,op_-1)+"026"+SUBS(drvtapg,op_+3)
...
//    @ cl,069 SAY TRAN(IIF(!CSTSEG->(EOF()),CSTSEG->vlorig,valor),"@E 999,999.99")// Valor Contribuicao 2
		...
		REL_CAB(1)                                     // soma cl/imprime cabecalho
		@ cl,015 SAY "TOTAL.:"
		@ cl,023 SAY TRAN(valororig,"@E 999,999.99")       // Valor Total
		@ cl,062 SAY "TOTAL.:"
		@ cl,069 SAY TRAN(valororig,"@E 999,999.99")       // Valor Total 2
		...
		REL_CAB(2)                                     // soma cl/imprime cabecalho
		@ cl,039 SAY &drvpcom+rmen1+&drvtcom		 // Mens1
		REL_CAB(1)                                     // soma cl/imprime cabecalho
		@ cl,039 SAY &drvpcom+rmen2+&drvtcom     // Mens2
		IF M->combarra=[S]
		 CODBARRAS({{codigo+tipo+circ,4,13,19}},10,6)
		ENDI
		REL_CAB(1)                                     // soma cl/imprime cabecalho
		@ cl,039 SAY &drvpcom+CIRCULAR->menscirc+&drvtcom// Mens 3
		IF M->combarra=[S]
		 CODBARRAS({{codigo+tipo+circ,4,13,19}},10,6)
		ENDI
