/*
 ...
 \ Funcao..: Ficha de Acerto - Periodigo Baldochi
...
IF !EMPTY(drvtapg)                                 // existe configuracao de tam pag?
 ...
 lpp_022=LEFT(drvtapg,op_-1)+"033"+SUBS(drvtapg,op_+3)
    ...
    ENDI ccop <= 2
     ...
     IF ccop <= 2
      IF cl+3>maxli                                 // se cabecalho do arq filho
		  ...
		  cl+=1                                         // soma contador de linha
		  IMPAC("Circular Vencimento    Valor",cl,002)
		  IMPCTL(drvpenf)
		  @ cl,37 SAY [*Valor em atraso: ]+TRAN(vlatras,"@E 999,999.99")   // Valor
		  IMPCTL(drvtenf)
		  cl+=1                                         // soma contador de linha
		  IMPAC("Observa‡„o:",cl,037)
...
*/
     ...
     IF ccop <= 2
		  ...
		  @ cl,038 SAY [Contratante:____________________________]
