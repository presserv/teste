...
/*
 ...
 \ Funcao..: EmissÑo Boleto Banc†rio
...
@ l_s+07,c_s+1 SAY "     Acumular valor das cobranáas vencidas?"
...
DO WHILE .t.
 ...
 @ l_s+01 ,c_s+20 GET  rtp;
		  PICT "!";
		  VALI CRIT("rtp $ [123]~TIPO nÑo aceit†vel");
		  WHEN "MTAB([1=J¢ia |2=Taxa |3=Carnà],[TIPO])"
 ...
 @ l_s+16 ,c_s+09 GET  mens7
                  AJUDA "Entre com a sÇtima linha de mensagem|a ser impressa no boleto"
 ...
 @ l_s+18 ,c_s+30 GET  confirme;
                  PICT "!";
                  VALI CRIT("confirme='S'.AND.V87001F9()~CONFIRME nÑo aceit†vel")
...
//    ENDI
    ...
    REL_CAB(1)                                     // soma cl/imprime cabecalho
    @ cl,002 SAY GRUPOS->endereco                  // Endereáo
...
msgt="PROCESSAMENTOS DO RELAT¢RIO|EMISSéO BOLETO BANCèRIO"
ALERTA()
op_=DBOX("Prosseguir|Cancelar operaáÑo",,,E_MENU,,msgt)
IF op_=1
