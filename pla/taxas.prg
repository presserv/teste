 ...
 */
 ...
 @ l_s+l_a,c_s+09 GET  tipo;
                  PICT sistema[op_sis,O_CAMPO,02,O_MASC]
                  DEFINICAO 2

 @ l_s+l_a,c_s+11 GET  circ;
 ...
 ELSE                                              // se nao rola a campos para cima
  ...
  SCROLL(l_s+Sistema[op_sis,O_TELA,O_SCROLL],c_s+09,l_max-1,c_s+09,1)
  SCROLL(l_s+Sistema[op_sis,O_TELA,O_SCROLL],c_s+11,l_max-1,c_s+13,1)
  SCROLL(l_s+Sistema[op_sis,O_TELA,O_SCROLL],c_s+15,l_max-1,c_s+22,1)
  SCROLL(l_s+Sistema[op_sis,O_TELA,O_SCROLL],c_s+23,l_max-1,c_s+32,1)
  SCROLL(l_s+Sistema[op_sis,O_TELA,O_SCROLL],c_s+34,l_max-1,c_s+41,1)
  SCROLL(l_s+Sistema[op_sis,O_TELA,O_SCROLL],c_s+42,l_max-1,c_s+51,1)
  SCROLL(l_s+Sistema[op_sis,O_TELA,O_SCROLL],c_s+53,l_max-1,c_s+54,1)
  SCROLL(l_s+Sistema[op_sis,O_TELA,O_SCROLL],c_s+56,l_max-1,c_s+56,1)
  SCROLL(l_s+Sistema[op_sis,O_TELA,O_SCROLL],c_s+68,l_max-1,c_s+75,1)
  SCROLL(l_s+Sistema[op_sis,O_TELA,O_SCROLL],c_s+58,l_max-1,c_s+66,1)
 ENDI
ENDD
...
@ l_s+02,c_s+1 SAY "ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ"
@ l_s+03,c_s+1 SAY "                                ³"
@ l_s+04,c_s+1 SAY "                              ³"
@ l_s+05,c_s+1 SAY "                              ³"
@ l_s+06,c_s+1 SAY "                              ³"
